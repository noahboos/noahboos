...
## About me
As you probably guessed from the "Bonjour", I am a French developer. I call myself *Rift* in this README.md, but I am also known as *Noah Boos* and *Propzonzon*. I mainly work as a full-stack web developer, but I really enjoy software and video game development too. I contribute to communities such as *Minecraft* and *Obsidian* through mods, plugins, and themes.
...
- [*Rift's Obsidian Laboratory*](https://github.com/rifts-obsidian-laboratory) — The organization where you can find all my *Obsidian*-related projects. It includes plugins, themes, snippets, and libraries.
- [*Rift's Minecraft Laboratory*](https://github.com/rifts-minecraft-laboratory) — The organization where you can find all my *Minecraft*-related projects. It mainly features mods made for *NeoForge*. Additional projects for other mod or plugin launchers may also appear. 🤷‍♂️
- [*Rift's Project Graveyard*](https://github.com/rifts-project-graveyard) — The organization where you can find all my dead projects. It includes school assignments, no-longer-maintained projects, or things I simply lost interest in.

## Stacks
The following stacks have been sorted with *Perplexity AI*, the sorting does not reflect any mastery of the corresponding stacks.
